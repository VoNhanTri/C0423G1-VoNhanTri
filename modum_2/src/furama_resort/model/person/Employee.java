...
public class Employee extends Person {
    ...
    public Employee(String code, String name, String date, String gender, int identityCard, int numberPhone, String email, String level, String position, float salary) {
